...
public class RobotHardwareCompbot extends RobotHardware {
	...
	*/	
	...
	public void initialize() {
		...
		addAuton(new AutonStrategyPosAGear());
		addAuton(new AutonStrategyPosCGear());
		addAuton(new AutonStrategyPosBGear());
		addAuton(new AutonStrategyPosAShoot());
	...
	public void teleop() {
		...
		*/	
		...
		/**
		if(Gamepad.secondaryAttackJoystick.getA())//drives to bottom from top or middle
		{
			gearTray.set(-.65);
